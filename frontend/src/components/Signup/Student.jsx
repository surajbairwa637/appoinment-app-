...
function StudentRegister() 
{
  ...
  async function submitHandler(event) {
    ...
    if (!formData.name || !formData.email || !formData.age || !formData.department || !formData.password) {
    ...
    setSpinner(true);
    try {
      const response = await fetch(`${import.meta.env.VITE_BACKEND_URL}/api/v1/student/register`, {
        method: "POST",
        headers: {
